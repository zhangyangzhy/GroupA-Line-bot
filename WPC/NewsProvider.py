...
class NewsProvider:
    ...
    def __fetch__news(self):
        ...
        content = ['''Hong Kong has issued a red travel alert on the United States, Britain and Ireland and will impose a 14-day quarantine period on all arrivals from the three countries and Egypt from Thursday in a bid to halt the number of imported Covid-19 infections.
